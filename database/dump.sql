...
CREATE TABLE MEMBER (
    ...
    award_miles         INT             NOT NULL DEFAULT 0,
...
('alice.johnson@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Alice',            'Johnson',      '+62',  '81234567801', '1990-05-15', 'Indonesia'),
('budi.santoso@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Budi',             'Santoso',      '+62',  '81234567802', '1985-08-22', 'Indonesia'),
('carol.williams@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mrs.', 'Carol',            'Williams',     '+62',  '81234567803', '1992-03-10', 'Indonesia'),
('david.brown@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'David',            'Brown',        '+65',  '91234567804', '1988-11-30', 'Singapore'),
('eva.davis@email.com',         extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Eva',              'Davis',        '+62',  '81234567805', '1995-07-04', 'Indonesia'),
('fajar.pratama@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Fajar',            'Pratama',      '+62',  '81234567806', '1991-02-18', 'Indonesia'),
('gita.lestari@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Gita',             'Lestari',      '+62',  '81234567807', '1993-09-25', 'Indonesia'),
('hendra.wijaya@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Hendra',           'Wijaya',       '+62',  '81234567808', '1987-12-01', 'Indonesia'),
('indah.permata@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Indah',            'Permata',      '+62',  '81234567809', '1994-04-14', 'Indonesia'),
('joko.susilo@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Joko',             'Susilo',       '+62',  '81234567810', '1982-06-30', 'Indonesia'),
('kartini.dewi@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Kartini',          'Dewi',         '+62',  '81234567811', '1996-01-21', 'Indonesia'),
('lukman.hakim@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Lukman',           'Hakim',        '+62',  '81234567812', '1989-03-07', 'Indonesia'),
('maya.sari@email.com',         extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Maya',             'Sari',         '+62',  '81234567813', '1997-10-19', 'Indonesia'),
('nanda.putra@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Nanda',            'Putra',        '+62',  '81234567814', '1986-07-11', 'Indonesia'),
('olivia.tan@email.com',        extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Olivia',           'Tan',          '+65',  '91234567815', '1993-12-28', 'Singapore'),
('pandu.wicaksono@email.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Pandu',            'Wicaksono',    '+62',  '81234567816', '1990-08-03', 'Indonesia'),
('qisthi.rahmah@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Qisthi',           'Rahmah',       '+62',  '81234567817', '1998-05-17', 'Indonesia'),
('reza.firmansyah@email.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Reza',             'Firmansyah',   '+62',  '81234567818', '1984-11-09', 'Indonesia'),
('sari.dewi@email.com',         extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Sari',             'Dewi',         '+62',  '81234567819', '1991-06-22', 'Indonesia'),
('tono.hartono@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Tono',             'Hartono',      '+62',  '81234567820', '1983-02-14', 'Indonesia'),
('udin.saputra@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Udin',             'Saputra',      '+62',  '81234567821', '1995-09-08', 'Indonesia'),
('vina.kusuma@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Vina',             'Kusuma',       '+62',  '81234567822', '1992-04-30', 'Indonesia'),
('wahyu.nugroho@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Wahyu',            'Nugroho',      '+62',  '81234567823', '1988-01-16', 'Indonesia'),
('xena.putri@email.com',        extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Xena',             'Putri',        '+62',  '81234567824', '1999-07-05', 'Indonesia'),
('yoga.pratama@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Yoga',             'Pratama',      '+62',  '81234567825', '1994-03-23', 'Indonesia'),
('zara.amelia@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Zara',             'Amelia',       '+62',  '81234567826', '1997-11-12', 'Indonesia'),
('andre.halim@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Andre',            'Halim',        '+62',  '81234567827', '1986-08-27', 'Indonesia'),
('bella.safitri@email.com',     extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Bella',            'Safitri',      '+62',  '81234567828', '1993-05-04', 'Indonesia'),
('candra.utama@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Candra',           'Utama',        '+62',  '81234567829', '1990-12-18', 'Indonesia'),
('dini.rahayu@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Dini',             'Rahayu',       '+62',  '81234567830', '1996-02-09', 'Indonesia'),
('eko.suryanto@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Eko',              'Suryanto',     '+62',  '81234567831', '1981-10-31', 'Indonesia'),
('fina.kurniawati@email.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Fina',             'Kurniawati',   '+62',  '81234567832', '1994-06-15', 'Indonesia'),
('guntur.perdana@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Guntur',           'Perdana',      '+62',  '81234567833', '1987-04-02', 'Indonesia'),
('hani.astuti@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Hani',             'Astuti',       '+62',  '81234567834', '1998-09-20', 'Indonesia'),
('ivan.christian@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Ivan',             'Christian',    '+62',  '81234567835', '1985-01-07', 'Indonesia'),
('julia.sekarsari@email.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Julia',            'Sekarsari',    '+62',  '81234567836', '1992-07-24', 'Indonesia'),
('kevin.lim@email.com',         extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Kevin',            'Lim',          '+60',  '121234567837','1989-03-13', 'Malaysia'),
('linda.wulandari@email.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Linda',            'Wulandari',    '+62',  '81234567838', '1995-11-26', 'Indonesia'),
('mario.setiawan@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Mario',            'Setiawan',     '+62',  '81234567839', '1983-08-10', 'Indonesia'),
('nina.anggraini@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Nina',             'Anggraini',    '+62',  '81234567840', '1997-05-29', 'Indonesia'),
('oscar.manurung@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Oscar',            'Manurung',     '+62',  '81234567841', '1991-02-04', 'Indonesia'),
('putri.maharani@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Putri',            'Maharani',     '+62',  '81234567842', '1996-09-17', 'Indonesia'),
('qodir.rahman@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Qodir',            'Rahman',       '+62',  '81234567843', '1984-06-06', 'Indonesia'),
('rina.melati@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Rina',             'Melati',       '+62',  '81234567844', '1993-01-23', 'Indonesia'),
('surya.hermawan@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Surya',            'Hermawan',     '+62',  '81234567845', '1988-04-08', 'Indonesia'),
('tika.pradana@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Tika',             'Pradana',      '+62',  '81234567846', '1999-12-01', 'Indonesia'),
('ujang.sopyan@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Ujang',            'Sopyan',       '+62',  '81234567847', '1980-07-19', 'Indonesia'),
('vera.chandra@email.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Vera',             'Chandra',      '+62',  '81234567848', '1994-10-15', 'Indonesia'),
('wibowo.purnomo@email.com',    extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Wibowo',           'Purnomo',      '+62',  '81234567849', '1982-03-28', 'Indonesia'),
('yuni.astuti@email.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Yuni',             'Astuti',       '+62',  '81234567850', '1997-08-14', 'Indonesia'),
('agus.budi@garuda.com',        extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Agus',             'Budi',         '+62',  '82111111101', '1980-01-15', 'Indonesia'),
('siti.rahayu@garuda.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Siti',             'Rahayu',       '+62',  '82111111102', '1983-04-22', 'Indonesia'),
('bambang.s@lionair.com',       extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Bambang',          'Sukirno',      '+62',  '82111111103', '1978-09-10', 'Indonesia'),
('dewi.indah@lionair.com',      extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Dewi',             'Indah',        '+62',  '82111111104', '1985-06-30', 'Indonesia'),
('erik.santoso@citilink.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Erik',             'Santoso',      '+62',  '82111111105', '1982-11-05', 'Indonesia'),
('fitri.nurhayati@citilink.com',extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Fitri',            'Nurhayati',    '+62',  '82111111106', '1987-02-18', 'Indonesia'),
('galih.prabowo@batikair.com',  extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Galih',            'Prabowo',      '+62',  '82111111107', '1984-07-23', 'Indonesia'),
('hesti.w@batikair.com',        extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Hesti',            'Wulandari',    '+62',  '82111111108', '1990-03-14', 'Indonesia'),
('irfan.maulana@airasia.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Mr.',  'Irfan',            'Maulana',      '+62',  '82111111109', '1986-10-07', 'Indonesia'),
('jasmine.putri@airasia.com',   extensions.crypt('password123', extensions.gen_salt('bf')), 'Ms.',  'Jasmine',          'Putri',        '+62',  '82111111110', '1991-05-29', 'Indonesia');

INSERT INTO MEMBER (email, nomor_member, tanggal_bergabung, id_tier, award_miles, total_miles) VALUES
('alice.johnson@email.com',     'M0001', '2022-01-15', 'T001', 5000, 15000),
('budi.santoso@email.com',      'M0002', '2022-02-20', 'T001', 1200, 2000),
('carol.williams@email.com',    'M0003', '2022-03-05', 'T001', 0, 0),
('david.brown@email.com',       'M0004', '2022-04-10', 'T001', 10000, 10000),
('eva.davis@email.com',         'M0005', '2022-05-22', 'T001', 2000, 5000),
('fajar.pratama@email.com',     'M0006', '2022-06-01', 'T001', 0, 0),
('gita.lestari@email.com',      'M0007', '2022-07-14', 'T001', 0, 0),
('hendra.wijaya@email.com',     'M0008', '2022-08-09', 'T001', 0, 0),
('indah.permata@email.com',     'M0009', '2022-09-03', 'T001', 0, 0),
('joko.susilo@email.com',       'M0010', '2022-10-18', 'T001', 0, 0),
('kartini.dewi@email.com',      'M0011', '2022-11-25', 'T001', 0, 0),
('lukman.hakim@email.com',      'M0012', '2022-12-07', 'T001', 0, 0),
('maya.sari@email.com',         'M0013', '2023-01-19', 'T001', 0, 0),
('nanda.putra@email.com',       'M0014', '2023-02-28', 'T001', 0, 0),
('olivia.tan@email.com',        'M0015', '2023-03-15', 'T001', 0, 0),
('pandu.wicaksono@email.com',   'M0016', '2023-04-22', 'T001', 0, 0),
('qisthi.rahmah@email.com',     'M0017', '2023-05-11', 'T001', 0, 0),
('reza.firmansyah@email.com',   'M0018', '2023-06-30', 'T001', 0, 0),
('sari.dewi@email.com',         'M0019', '2023-07-04', 'T001', 0, 0),
('tono.hartono@email.com',      'M0020', '2023-08-17', 'T001', 0, 0),
('udin.saputra@email.com',      'M0021', '2021-01-10', 'T002', 30000, 30000),
('vina.kusuma@email.com',       'M0022', '2021-02-14', 'T002', 28000, 28000),
('wahyu.nugroho@email.com',     'M0023', '2021-03-20', 'T002', 26000, 26000),
('xena.putri@email.com',        'M0024', '2021-04-08', 'T002', 0, 0),
('yoga.pratama@email.com',      'M0025', '2021-05-16', 'T002', 0, 0),
('zara.amelia@email.com',       'M0026', '2021-06-29', 'T002', 0, 0),
('andre.halim@email.com',       'M0027', '2021-07-03', 'T002', 0, 0),
('bella.safitri@email.com',     'M0028', '2021-08-21', 'T002', 0, 0),
('candra.utama@email.com',      'M0029', '2021-09-12', 'T002', 0, 0),
('dini.rahayu@email.com',       'M0030', '2021-10-05', 'T002', 0, 0),
('eko.suryanto@email.com',      'M0031', '2021-11-18', 'T002', 0, 0),
('fina.kurniawati@email.com',   'M0032', '2021-12-26', 'T002', 0, 0),
('guntur.perdana@email.com',    'M0033', '2022-01-31', 'T002', 0, 0),
('hani.astuti@email.com',       'M0034', '2022-02-07', 'T002', 0, 0),
('ivan.christian@email.com',    'M0035', '2022-03-13', 'T002', 0, 0),
('julia.sekarsari@email.com',   'M0036', '2020-01-05', 'T003', 60000, 120000),
('kevin.lim@email.com',         'M0037', '2020-03-17', 'T003', 55000, 110000),
('linda.wulandari@email.com',   'M0038', '2020-05-22', 'T003', 52000, 105000),
('mario.setiawan@email.com',    'M0039', '2020-07-08', 'T003', 0, 0),
('nina.anggraini@email.com',    'M0040', '2020-09-14', 'T003', 0, 0),
('oscar.manurung@email.com',    'M0041', '2020-11-01', 'T003', 0, 0),
('putri.maharani@email.com',    'M0042', '2021-01-20', 'T003', 0, 0),
('qodir.rahman@email.com',      'M0043', '2021-03-09', 'T003', 0, 0),
('rina.melati@email.com',       'M0044', '2021-05-27', 'T003', 0, 0),
('surya.hermawan@email.com',    'M0045', '2021-07-16', 'T003', 0, 0),
('tika.pradana@email.com',      'M0046', '2019-06-01', 'T004', 150000, 300000),
('ujang.sopyan@email.com',      'M0047', '2019-08-11', 'T004', 140000, 280000),
('vera.chandra@email.com',      'M0048', '2019-10-25', 'T004', 130000, 260000),
('wibowo.purnomo@email.com',    'M0049', '2019-12-30', 'T004', 120000, 240000),
('yuni.astuti@email.com',       'M0050', '2020-02-19', 'T004', 110000, 220000);
...
('RWD-001', 'Diskon Menginap 20%',          5000,   'Diskon 20% untuk menginap di Hotel Santika seluruh Indonesia',         '2025-01-01', '2027-12-31', 6),
('RWD-002', 'Free Breakfast 2 Pax',         3000,   'Sarapan gratis untuk 2 orang di Hotel Santika',                        '2025-01-01', '2027-12-31', 6),
('RWD-003', 'Voucher Makan Rp 150.000',     2000,   'Voucher makan siang/malam di Restoran Padang Sederhana',               '2025-01-01', '2027-12-31', 8),
('RWD-004', 'Upgrade Kabin Gratis',         10000,  'Upgrade ke Business Class untuk 1 penerbangan Garuda Indonesia',       '2025-03-01', '2027-12-31', 1),
('RWD-005', 'VIP Lounge Access CGK',        4000,   'Akses VIP Lounge di Bandara Soekarno-Hatta',                          '2025-01-01', '2027-12-31', 1),
('RWD-006', 'Diskon Rental Mobil 30%',      3500,   'Diskon 30% sewa kendaraan di Trans Rental Car seluruh Indonesia',      '2025-02-01', '2027-12-31', 9),
('RWD-007', 'Shopping Voucher Rp 300.000',  7000,   'Voucher belanja di Plaza Indonesia Jakarta',                           '2025-01-15', '2027-12-31', 10),
('RWD-008', 'Extra Bagasi 10kg',            2500,   'Tambahan bagasi 10kg untuk 1 penerbangan Garuda Indonesia',            '2025-01-01', '2027-12-31', 1),
('RWD-009', 'Free Night Grand Hyatt',       20000,  'Menginap gratis 1 malam di Grand Hyatt Jakarta (Superior Room)',       '2025-04-01', '2027-12-31', 7),
('RWD-010', 'Priority Check-in',            1500,   'Priority check-in dan boarding untuk penerbangan Lion Air',            '2025-01-01', '2027-12-31', 2);
